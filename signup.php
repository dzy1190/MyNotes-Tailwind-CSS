...
<body class="bg-auto dark:bg-gray-900 flex items-center justify-center min-h-screen relative overflow-hidden">
    ...
    <div class="bg-auto p-8 rounded-lg shadow-md w-full max-w-md relative z-10 backdrop-blur-sm bg-opacity-80">
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-gray-200">Sign Up</h2>
        <form action="register_action.php" method="POST">
            ...
            <div class="mb-6">
                <label for="password" class="block text-gray-700 dark:text-gray-400 text-sm font-bold mb-2">Create Password</label>
